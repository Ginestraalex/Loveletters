...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'jeu_platform_homepage');
            }
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            // jeu_platform_edit
            if ('/platform/edit' === $pathinfo) {
                return array (  '_controller' => 'JEU\\PlatformBundle\\Controller\\AdvertController::editAction',  '_route' => 'jeu_platform_edit',);
            }
